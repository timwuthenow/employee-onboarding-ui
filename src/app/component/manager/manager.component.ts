...
export class ManagerComponent implements OnInit {
  ...
  open() {
    const modalRef = this.modalService.open(NewEmployeeComponent, { ariaLabelledBy: 'modal-basic-title', size: 'xl', backdrop: 'static' });
    ...
    //modalRef.componentInstance.country = this.countryCode;
  }
  ...
  private openManagerTask(response : any) {
    const modalRef = this.modalService.open(ManagerTaskComponent, { ariaLabelledBy: 'modal-basic-title', size: 'xl', backdrop: 'static' });
