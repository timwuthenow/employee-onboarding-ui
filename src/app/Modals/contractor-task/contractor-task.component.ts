...
@Component({
  selector: 'app-contractor-task',
  templateUrl: './contractor-task.component.html',
  styleUrls: ['./contractor-task.component.css']
})
export class ContractorTaskComponent implements OnInit {
